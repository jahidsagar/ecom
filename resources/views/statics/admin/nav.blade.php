        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{{url('/color')}}">Colors</a>
                    <a class="nav-link" href="{{url('/size')}}">Sizes</a>
                    <a class="nav-link" href="{{url('/weight')}}">Weights</a>
                    <a class="nav-link" href="{{url('/scale')}}">Scales</a>
                    <a class="nav-link" href="{{url('/brand')}}">Brands</a>
                </nav>
            </div>
